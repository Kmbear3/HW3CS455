...
public class Question1 {
	public static class MapperQ1 extends Mapper<Object, Text, Text, IntWritable> {
    ...
    public static class ReducerQ1 extends Reducer<Text, IntWritable, Text, DoubleWritable>{
